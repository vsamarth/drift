...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 132458473;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        1 => wire__crate__api__receiver__current_receiver_registration_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        2 => wire__crate__api__receiver__ensure_receiver_registration_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        7 => wire__crate__api__receiver__register_receiver_impl(port, ptr, rust_vec_len, data_len),
        8 => wire__crate__api__receiver__respond_to_receiver_offer_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        9 => wire__crate__api__lan__scan_nearby_receivers_impl(port, ptr, rust_vec_len, data_len),
        10 => wire__crate__api__receiver__set_receiver_discoverable_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        11 => wire__crate__api__receiver__start_receiver_transfer_listener_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        12 => wire__crate__api__sender__start_send_transfer_impl(port, ptr, rust_vec_len, data_len),
        13 => wire__crate__api__receiver__watch_receiver_pairing_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
