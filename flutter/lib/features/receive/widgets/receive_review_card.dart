...
class ReceiveReviewCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final saveRoot = summary == null || summary.destinationLabel.trim().isEmpty
        ? 'Downloads'
        : summary.destinationLabel.trim();
    final senderDeviceType = state.receiveSenderDeviceType ?? 'laptop';
    final notifier = ref.read(receiveControllerProvider.notifier);
